...
FlowRouter.route('/app_login', {
    name: 'app-login',
    action: renderPage('app_login')
});
...
FlowRouter.route('/categorias', {
    name: 'Categorias',
    action: renderLayout('Categorias')
});

FlowRouter.route('/equipos', {
    name: 'Equipos',
    action: renderLayout('Equipos')
});

FlowRouter.route('/jugadores', {
    name: 'Jugadores',
    action: renderLayout('Jugadores')
});
// Router transitions
